  ...
  try {
    ...
    if (process.env.RESEND_API_KEY && email) {
      ...
      const confirmHtml = '<div style="font-family:sans-serif;max-width:520px;margin:0 auto">' +
        ...
        '<p style="color:#374151;font-size:14px;line-height:1.6;margin:0 0 16px">Thank you for applying to join CareVoy as a ' + appType + '. We have received your application and will be in touch as soon as possible.</p>' +
